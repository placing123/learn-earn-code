...
<?php $__env->startSection('title', 'Admin Customization - Admin'); ?>
        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('Admin Customization')); ?></h5>
                </div>
                <!-- card body started -->
                <div class="card-body">
                    <!-- form start -->
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mm9mvjkm3u88/public_html/resources/views/admin/admincustomisation/view.blade.php ENDPATH**/ ?>