...
<?php $__env->startSection('title','All Drop'); ?>
        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    <h5 class="box-title"><?php echo e(__('All Drop down Setting')); ?></h5>
                    <div>
                        <div class="widgetbar">
                            <a href="<?php echo e(route('dropdown.create')); ?>" class="float-right btn btn-primary-rgba mr-2"><i
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                <a class="dropdown-item" href="<?php echo e(url('dropdown/'.$cat->id.'/edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mm9mvjkm3u88/public_html/resources/views/admin/drop/index.blade.php ENDPATH**/ ?>