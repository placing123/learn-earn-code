...
unset($__errorArgs, $__bag); ?>" name="name" id="sub_heading" value="<?php echo e($language->name); ?>" placeholder="Please enter language name eg:English" required>
								...
								<div class="form-group col-md-2">
									<label class="text-dark" for="exampleInputDetails"><?php echo e(__('SetDefault')); ?> :</label><br>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mm9mvjkm3u88/public_html/resources/views/admin/language/edit.blade.php ENDPATH**/ ?>