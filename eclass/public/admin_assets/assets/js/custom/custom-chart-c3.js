...
$(document).ready(function() {
    ...
    var scatterPlotChart = c3.generate({
        ...
        color: { pattern: ["#f2f3f7", "#43d187", "#506fe4"] },
        data: {
            xs: {
                setosa: 'setosa_x',
    ...
    var stackedBarChart = c3.generate({
        ...
        color: { pattern: ["#f2f3f7", "#506fe4", "#43d187"] },
        data: {
            columns: [
    ...
    var combinationChart = c3.generate({
        ...
        color: { pattern: ["#506fe4", "#f2f3f7", "#f9616d", "#3d9bfb", "#43d187", "#f7bb4d"] },
        data: {
            columns: [
    ...
    var gaugeChart = c3.generate({
        ...
        color: {
            pattern: ['#43d187', '#f9616d', '#f7bb4d', '#506fe4'],
            threshold: {
                values: [30, 60, 90, 100]
            }
        },
    ...
    var pieChart = c3.generate({
        bindto: '#c3-pie',
        color: { pattern: ["#506fe4", "#f2f3f7", "#43d187"] },
        data: {
            columns: [
                ['SeriesA', 40],
                ['SeriesB', 25],
